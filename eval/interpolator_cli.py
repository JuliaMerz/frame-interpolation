...
_TIMES_TO_INTERPOLATE = flags.DEFINE_integer(
    ...
    "The number of output frames will be 2^times_to_interpolate+1+bounce.",
)
_BOUNCE = flags.DEFINE_integer(
    name="bounce",
    default=0,
    help="The number of times to freeze when passing through the input frames."
    "The number of output frames will be 2^times_to_interpolate+1+bounce.",
)
